...
// Source: https://gist.github.com/dustingraham/9fa7b68b09fadf01661c3d500c9f01d9
...
namespace TransparentGames.Essentials
{
    ...
    {
        private static readonly Dictionary<ScriptableObjectWithId, string> ObjectToString = new();
        private static readonly Dictionary<string, ScriptableObjectWithId> StringToObject = new();

        [SerializeField] private string internalId;
        [SerializeField] private long createdAtTicks;

        [NonSerialized] private bool _internalIdWasUpdated;
        ...
        {
            obj.internalId = Guid.NewGuid().ToString("N");
