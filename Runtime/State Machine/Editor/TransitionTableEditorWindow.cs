...
using Essentials.StateMachine.ScriptableObjects;

namespace Essentials.StateMachine.Editor
{
	internal class TransitionTableEditorWindow : EditorWindow
	{
		...
		[MenuItem("State Machine Editor", menuItem = "Essentials/State Machine Editor")]
